...
<div class="box">
	...
	<div class="one-shop">	
    	...
    	<input type="hidden" id="subOrderId" name="subOrderId" value="${ord.subOrderId}"/>
    	<input type="hidden" name="returnOrderApplyType" value="2"/>
    	<input type="hidden" id="proudctInfoStr" name="proudctInfoStr" value="${proudctInfoStr}"/>
    	<input type="hidden" name="storeCode" value="${ord.productInfos[0].storeCode}"/>
        <input type="hidden" name="counterCode" value="${ord.productInfos[0].counterCode}"/>
	    ...
	    <div class="shop-total">
	        <label for="1">
	            <input type="checkbox" class="goods-check ShopCheck" id="1">申请全部退款
	        </label>
	    </div>
    </div>
</div>
<div class="return_fix">
	<a id="nextStep" class="fr submit red">提交</a><em>已选择<span>0</span>件商品</em>
</div>
...
<script type="text/javascript" src="${SERVER_WAP_SHOP}/resources/js/refund/return-money.js"></script>
</body>
</html>
