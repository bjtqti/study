/********************jquery.validationEngine-zh_CN   中文表单验证规则************************/
(function ($) {
        ...
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                ...
                "price": {
                    ...
                    "regex": /^([0-9]{1,3}\,)?([0-9]{3}\,)*([0-9]{0,3})\.[0-9]{2}$/,
                    "alertText": "* 无效的价格"
                },
                "phone": {
                    // credit: jquery.h5validate.js / orefalo
                ...
                "postCode": {
                    // credit: jquery.h5validate.js / orefalo  /^[0-9]{6}$/;
                    "regex": /^[0-9]{6}$/,
                    "alertText": "* 邮编只能由6位数字组成"
                },
                "fileLoad": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^[a-zA-Z]:(\\.+)(.JPEG|.jpeg|.JPG|.jpg|.GIF|.gif|.BMP|.bmp|.PNG|.png)$/,
                    "alertText": "* 图片格式不正确,仅支持ie"
                },
                "keyword": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^[a-zA-Z0-9\,\u4e00-\u9fa5]*$/,
                    "alertText": "* 关键词只允许汉字、数字、字母和英文逗号！"
                },
                "docLoad": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^[a-zA-Z]:(\\.+)(.docx|.doc|.txt|.xls|.xlsx)$/,
                    "alertText": "* 文件格式必须为word、excel、txt"
                },
                "cardNumber": {
                    // credit: jquery.h5validate.js / orefalo  /^[0-9]{6}$/;
                    "regex": /^\d{15}$|^\d{17}(?:\d|x|X)$/,
                    "alertText": "* 身份证号码只能 由15或18位数字组成"
                },
                "loginName": {
                    // credit: jquery.h5validate.js / orefalo  /^[0-9]{6}$/;
                    "regex": /^[a-zA-Z]{1}\w{5,20}$/,
                    "alertText": "* 登陆账号 必须以字母开头 长度6－20位"
                },
                "userName": {
                    // credit: jquery.h5validate.js / orefalo  /^[0-9]{6}$/;
                    "regex": /^[\u4E00-\u9FA5]{2,6}$/,
                    "alertText": "* 只能由2到6位汉字组成"
                },
                "onlyChinese": {
                    // credit: jquery.h5validate.js / orefalo  /^[0-9]{6}$/;
                    "regex": /^[\u4E00-\u9FA5]+$/,
                ...
                "onlyEnglishAddress": {
                    ...
                    "alertText": "* 只接受点,字母,空格,逗号,数字且开头只能为字母"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* 不接受特殊字符"
                ...
                "ajaxNameCall": {
                    ...
                    "url": "/WX/user/validate.action?fresh=" + Math.random(),
                    // error
                    "alertText": "* 此名称可以使用",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
    ...
    if (fdivide) {
        if (arrayf[0].length > 3) {
            while (arrayf[0].length > 3) {
                revalue = ","
                    + arrayf[0].substring(arrayf[0].length - 3,
                        arrayf[0].length) + revalue;
    ...
    var methods = {
        ...
        _ajax: function (field, rules, i, options) {
            ...
            var data = {
                ...
                "ownIdName": field.attr("ownIdName"),
                "ownIdValue": field.attr("ownIdValue"),
                "parentIdName": field.attr("parentIdName"),
                "parentIdValue": field.attr("parentIdValue"),
